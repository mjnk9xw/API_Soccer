...
func ToursByID(id string) (rounds []models.RoundInfo, err error) {
	roundsID, err := serverstore.TourIDToListRoundID.GetByID(id)
	rounds = make([]models.RoundInfo, 0)
...
func RoundByID(id int64) (tables []models.TableInfo, err error) {
...
func PlayersInTour(id string) (players []models.PlayerInfo, err error) {
...
func PlayersInTable(id int64) (players []models.PlayerInfo, err error) {
...
func MatchInTable(id int64) (matchs []models.MatchInfo, err error) {
	matchsID, err := serverstore.TableIDToListMatchID.GetByID(id)
	matchs = make([]models.MatchInfo, 0)
